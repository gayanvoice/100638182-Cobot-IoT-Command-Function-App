...
namespace CobotIotCommandFunctionApp.Model.Response
{
    public class EnableControlCommandResponseModel
    {
        ...
        public EnableControlCommandResponseModel()
        {
            stopwatch = new Stopwatch();
            stopwatch.Start();
        }
        public EnableControlCommandResponseModel GetOkRequestRespondModel(string text)
        {
            stopwatch.Stop();
            Message = text;
        ...
        public class CommandResponseModel
        {
            ...
            public class PayloadModel
            {
                    ...
                    CloudToDeviceMethodResult cloudToDeviceMethodResult)
                {
                    ...
                    payloadModel.ElapsedTime = (double)jsonObject["elapsed_time"];
                    return payloadModel;
                }
            }
